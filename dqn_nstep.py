...
tag = params['run_name'] + "-nsteps-" + str(args.nsteps) +  '-'+ str(seed)
writer_folder = './runs/'+ params['run_name'] + "-nsteps-" + str(args.nsteps) + "/" + str(seed) +  '-' + datetime.datetime.now().strftime("%d-%b-%H-%M-%S")
